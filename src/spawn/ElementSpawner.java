 ...
 * 
 * @author Gang Song
 * @Description This class is mainly for creating a group of elements
 *              It is implemented by Strategy pattern and Generics
 *
 */
...
public class ElementSpawner<E extends Element> {
	...
	/**
	 * @param element is the type of the element that is going to be spawned
	 * @param 
	 */
	...
	public List<E> spawn() {
		...
		if (mySpawnBehavior.check()){
			...
			for (int i = 0; i < myElementNum; i++) {
				...
				E currentElement = (E) myElement.clone();// To clone the same kind of element
