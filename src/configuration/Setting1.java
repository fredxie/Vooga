...
//		for (int i  = 0; i < list.size(); i++) {
			mainPanel.add(keySetting(), mainPanel.getLayout());
//		}
		
//		mainPanel=(JPanel) parameterSetting();
		mainPanel.add(levelSetting());
		
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setLayout(new BorderLayout());
        add(mainPanel);
//        add(mainPanel1, BorderLayout.AFTER_LAST_LINE);
//        add(mainPanel2, BorderLayout.AFTER_LAST_LINE);
        pack();
        setVisible(true);
